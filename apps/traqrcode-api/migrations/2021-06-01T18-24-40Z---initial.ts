...
ALTER TABLE "company" ADD COLUMN IF NOT EXISTS "createdAt" timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE "m2m_company_user" ADD COLUMN IF NOT EXISTS "createdAt" timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE "m2m_page_user" ADD COLUMN IF NOT EXISTS "createdAt" timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
export const down = async (trx: Knex.Transaction) => {
  const cmd = `
DROP TABLE IF EXISTS "m2m_page_user";
DROP TABLE IF EXISTS "m2m_company_user";
