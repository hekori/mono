...
export const createRandomName = () => {
  const randomPositiveAdjective =
    positiveAdjectives[randInt(0, positiveAdjectives.length)]
  const randomeAnimal = animals[randInt(0, animals.length)]

  return `${randomPositiveAdjective} ${randomeAnimal}`
}
